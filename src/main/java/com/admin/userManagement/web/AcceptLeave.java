...
public class AcceptLeave extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
	        ...
	        int row_count = LeaveRequestDao.AcceptLeaveRequest(lreq,emp,empID);
	        
	         
			
	        if(row_count==1) {
	        	out.println(EmployeeDao.sendAlert("Leave Request Acepted ","AcceptRequest.jsp?emp_id="+emp._id+"&leave_id="+lreq.getLeaveId()));
