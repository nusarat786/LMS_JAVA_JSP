...
public class AuthenticationFilterOTP implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
    	...
    	try{
    		...
    		if (cookies != null) {
    		    for (Cookie cookie : cookies) {
    		    	...
    		    	if (cookie.getName().equals("otpSent")) {
    		            otpSent = Boolean.parseBoolean(cookie.getValue());
    		        }
    		...
    		ee.printStackTrace();
    		out.println(EmployeeDao.sendAlert("Alredy Logined!! Taking To Profile", "/LMS_V3/EmployPortal.jsp"));
    	
     	}catch(OTPFalseExeption ee) {
    		System.out.println();
    		ee.printStackTrace();
    		out.println(EmployeeDao.sendAlert("OTP Can Not Be Sent, Try Again", "/LMS_V3/GetOtp.jsp"));
...
class OTPFalseExeption extends Exception{
	
	@Override
	public String toString() {
		return "Otp Can Not Be Send";
	}
}

class AlredyLoginException extends Exception{
