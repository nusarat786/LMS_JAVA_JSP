	  ...
	  <div class="row">
	    <div class="col-12">
	      <div class="banner-card">
	        <div class="Login">
	          <h2 class="h-4">Please Enter OTP</h2>
	        </div>
	        <div>
	          <img src="https://iili.io/JMnhUfs.md.png" alt="usher" class="banner-image">
	        </div>
	      </div>
	    </div>
	  </div>
  ...
  <div class="row">
    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 offset-lg-1 offset-md-1 offset-sm-1 offset-xs-1">
      <div class="login-container">
        <form id="loginForm" class="" action="GetOtp" method="get" onsubmit="getSpinner();" >
          <div class="mb-3">
            ...
            <input type="number" class="form-control" id="emp_id" name="emp_id" value="${emp_id}" hidden>
         
          
          <button type="submit" class="btn  btn-block bg_main">Verify OTP</button>
          <div id="spinner" class="spinner-border text-primary bg_main2"  role="status" style="display:none;">
            <span class="visually-hidden">processing....</span>
          </div>
        </form>
        
        <form class="pt-1" id="GetOtp" action="Resendotp" method="get" onsubmit="getSpinner();">
          <button type="submit" class="btn  btn-block bg_main">Resend OTP </button>
          ...
          <div id="spinner2" class="spinner-border text-primary bg_main2" role="status" style="display:none;">
