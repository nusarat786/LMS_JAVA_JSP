...
<%
    List<LeaveRequestBean> lreq1 = LeaveRequestDao.getLeaveHistory();
    String desiredStatus = request.getParameter("status"); // Replace 'desired_status_value' with the status you want to filter by
    List<LeaveRequestBean> lreq = new ArrayList<>();

    for (LeaveRequestBean req : lreq1) {
        if (req.getStatus().equals(desiredStatus)) {
        	lreq.add(req);
        }
    }
%>
...
<div class="container-fluid border-con"> 
	    ...
	    <div class="col-md-12">
	      <div class="banner-card">
	        <div class="welcome-msg-container">
	          <h2 class="h-4">Leave Requests (<%=desiredStatus %>) </h2>
	        </div>
	        <div>
    ...
    <tbody>
        ...
        <tr>
        	<td>
            	<a href="../AcceptRequest.jsp?emp_id=<%= leave.getEmployeeId() %>&leave_id=<%= leave.getLeaveId() %>" class="fas fa-hand-pointer font-ivory"></a>            	    			
    	   </td>
